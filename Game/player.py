...
class Player(object):
	...
	def __init__(self, screen, message, fade):
		...
		self.sprites = {
			"left" : [image.load("resources/graphics/player/resized_left_move/tile%s.png"%str(i).zfill(3)).convert_alpha() for i in range(0,15)],
			"right": [image.load("resources/graphics/player/resized_right_move/tile%s.png"%str(i).zfill(3)).convert_alpha() for i in range(0,15)],
			"down": [image.load("resources/graphics/player/resized_back_move/tile%s.png"%str(i).zfill(3)).convert_alpha() for i in range(0,15)],
